...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 right-5 z-50 flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white shadow-xl backdrop-blur-md transition hover:scale-[1.05] hover:bg-white/10"
    >
